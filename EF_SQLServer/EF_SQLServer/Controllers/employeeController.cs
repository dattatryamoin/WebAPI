...
using EF_SQLServer.Models.EF;

namespace EF_SQLServer.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class employeeController : ControllerBase
    {
        private readonly TrainingContext _context = new TrainingContext();
        ...
        public async Task<ActionResult<EmployeeDetail>> PostEmployeeDetail(EmployeeDetail employeeDetail)
        {
          if (_context.EmployeeDetails == null)
          {
              return Problem("Entity set 'TrainingContext.EmployeeDetails'  is null.");
          }
